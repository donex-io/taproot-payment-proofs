...
#
# Go thorugh same test procedure as reference implementation
# * Copy test vectors of `reference_test_vectors.py`
# * Modifiy signing procedure: Exchange `schnorr_sign()` by `schnorr_sign_with_data()`
